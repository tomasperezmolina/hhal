...
inline void init_ack_command(command_base &cmd) {
  cmd.cmd = ACK;
}

inline void init_kernel_write_command(kernel_write_command &cmd, int kernel_id, size_t image_path_size) {
  cmd.cmd = KERNEL_WRITE;
  cmd.kernel_id = kernel_id;
  cmd.image_path_size = image_path_size;
}

inline void init_kernel_start_command(kernel_start_command &cmd, int kernel_id, size_t arguments_size) {
    cmd.cmd = KERNEL_START;
    cmd.kernel_id = kernel_id;
